@foreach ($users as $user)
  <span class="mr-1 active_user relative flex-shrink-0 cursor-pointer" onclick="showMessageContainer('1')"
    ...
    <img src="
      ...
      $user[config('messenger.avatar_field_name')]) {{ $user[config('messenger.avatar_field_name')] }}
  ...
  @else
    https://ui-avatars.com/api/?background=5f5ff8&name={{ str_replace(' ', '+', trim($user->name)) }}
    @endif " alt="
